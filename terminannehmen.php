...
if (!$conn){
 ...
 if(isset($_SESSION['id'])){
   if($_SESSION['id']==$kundenId || $_SESSION['rolle']=="Admin"){
    echo("<div>Bitte weisen sie dem Termin eine Uhrzeit zu alle anderen Felder sind nicht bearbeitbar.</div><div id='output'></div>");
...
echo("<tr><th>Abholort:</th><td><input type='text' name='abholort' value='$abholort' readonly></td></tr>");
   ...
   echo("<tr><th>Name:</th><td><input type='text' name='name' value='$vorNachname' readonly></td></tr>");
    ...
    echo("<tr><th>Notizen:</th><td><input type='text' name='Notizen' value='$sonstigeNotizen' readonly></td></tr><tr> <th>Uhrzeit zuweisen:</th><td><input type='time' name='Uhrzeit' required></tr></table>");
    echo("<br>");
